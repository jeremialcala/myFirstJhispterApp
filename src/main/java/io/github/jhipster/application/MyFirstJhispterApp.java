...
public class MyFirstJhispterApp {

    private static final Logger log = LoggerFactory.getLogger(MyFirstJhispterApp.class);

    private final Environment env;

    public MyFirstJhispterApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes myFirstJhispterApp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MyFirstJhispterApp.class);
